...
const STATEMENT =
    'Diversify Digital is a growth-minded digital marketing studio — pairing search strategy, expressive web development and performance campaigns to help ambitious brands get chosen.'

// Words to emphasise in the accent tone.
const ACCENT = new Set(['search', 'development', 'campaigns'])
            ...
            <div className="container">
                <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
                    <div className="lg:col-span-3">
                        <div className="label label-line text-clay">Why Diversify</div>
                        <p className="mt-6 max-w-[220px] text-sm leading-relaxed text-ink/60">
                            Clarity for your brand, momentum for your business, and a team that cares
                            about the details.
                        </p>
                    </div>
