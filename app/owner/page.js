              ...
              <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-[240px_1fr] lg:gap-12">
                ...
                <div>
                  ...
                  <p className="mt-4 max-w-[540px] text-[0.98rem] leading-relaxed text-white/65">
                    ...
                    ambitious brands deserve a partner who treats their growth
                    like their own. Not a vendor, not an order-taker, but a team
                    invested in the outcome.
                  </p>
                  <p className="mt-3 max-w-[540px] text-[0.98rem] leading-relaxed text-white/65">
                    From the first strategy call to the numbers on the board, he
                    keeps the whole engine aligned — SEO, paid media, web, brand
                    and creative all pulling in the same direction.
                  </p>
        ...
        >
          ...
          <blockquote className="mt-6">
            <p className="font-serif text-[clamp(1.1rem,2.5vw,1.4rem)] italic leading-relaxed text-white/75">
              ...
              marketing could be more honest, more integrated, and more human.
              Every brand we partner with gets the same thing — a team that
              cares about the outcome as much as they do. We don&apos;t just
              deliver work; we deliver growth you can see, track, and build on.
              That&apos;s the only standard worth having.&rdquo;
            </p>
          </blockquote>
        ...
        >
          ...
          <div className="flex flex-col border-t border-white/[0.08]">
            {PRINCIPLES.map((p) => (
              <div
                key={p.no}
                className="flex gap-6 border-b border-white/[0.08] py-8"
              >
                <span className="font-mono text-[0.8rem] text-violet-300/70">
                  {p.no}
                </span>
                <div>
      ...
      <div className="container relative">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-lg text-[0.95rem] leading-relaxed text-white/50">
            A tight-knit team of specialists — each one embedded across
            strategy, creative and technology so nothing falls through the
            cracks.
          </p>
        </motion.div>
    ...
    <Magnetic strength={isLead ? 0.15 : 0.25} as="div">
      <div className="group flex flex-col items-center text-center">
        ...
        <div className="mt-5 transition-transform duration-600 ease-out group-hover:-translate-y-1.5">
          <p
            className={`font-serif text-white transition-colors duration-500 group-hover:text-white ${
              isLead
          ...
          <p
            className={`mt-1.5 font-mono uppercase text-violet-300/50 transition-all duration-700 ease-out group-hover:tracking-[0.25em] group-hover:text-violet-300/70 ${
              isLead
