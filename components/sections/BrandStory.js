...
const LINE_2 = ['We', 'engineer', 'digital', 'momentum.']
...
export default function BrandStory() {
    ...
    return (
        <section ref={sectionRef} className="relative overflow-hidden bg-[#100b20] py-[clamp(5rem,12vw,14rem)]">
            ...
            <div className="container relative z-10">
                ...
                <div className="mx-auto mt-12 flex max-w-3xl flex-col items-center gap-8 text-center sm:mt-16">
                    ...
                    <p className="max-w-lg text-[1.05rem] leading-relaxed text-white/65">
                        Software engineering, cloud infrastructure, AI and digital marketing — all under one roof, moving in the same direction.
