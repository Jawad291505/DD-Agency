...
const PROJECTS = [
    {
        ...
        metrics: [
            ...
            { label: 'Scope', value: 'Ads · Shopify · Design · SEO · Social' },
        ],
    },
    {
        title: 'Agora',
        ...
        metrics: [
            ...
            { label: 'Scope', value: 'App Development · Graphic Design' },
        ],
    },
    {
        title: 'Eye Insights',
        ...
        metrics: [
            ...
            { label: 'Scope', value: 'Ads · Content Planning · Marketing' },
        ],
    },
    {
        title: 'Fitoo',
        ...
        metrics: [
            ...
            { label: 'Scope', value: 'Web · SEO · Design · Ad Campaigns' },
        ],
    },
    {
        title: 'Fit360',
        ...
        image: IMAGES.fit360,
        metrics: [
            { label: 'Focus', value: 'Web presence' },
            { label: 'Scope', value: 'Web Development' },
        ],
    },
    {
        ...
        metrics: [
            { label: 'Focus', value: 'Digital storefront' },
            { label: 'Scope', value: 'Web Development' },
        ],
    },
]
